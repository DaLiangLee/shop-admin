...
(function () {
  ...
  /** @ngInject */
  function routerRun($rootScope, $state, $window,$document, $log, permissions, cbAlert, previousState) {
    ...
    $rootScope.$on('$stateChangeStart', function (event, toState, toParams, fromState, fromParams) {
      ...
      if (fromState.interceptor) {
        ...
        cbAlert.confirm(fromState.interceptorMsg ? fromState.interceptorMsg : '您还没有保存，是否离开', function (isConfirm) {
          if (isConfirm) {
  ...
  $.post('http://localhost:3000/shopservice/login', {storecode: 'A1', username: '15871812356', password: '111111'});
  //buildend
