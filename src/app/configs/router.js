    ...
    function routerConfig($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state('store', { // 店铺管理
                ...
                permission: "shopapp:store:store:shop:view"
            })
            ...
            .state('store.shop.home', { // 店铺信息管理
                ...
                controllerAs: 'vm',
                title: '店铺管理',
                permission: "shopapp:store:store:shop:index"
            })
            ...
            .state('product', { // 产品管理
                ...
                template: '<div ui-view></div>',
                title: '产品管理',
                permission: "shopapp:store:product:goods:view"
            })
            ...
            .state('product.goods.add', { // 商品管理 新增商品
                ...
                controllerAs: 'vm',
                title: '添加商品',
                permission: "shopapp:store:product:goods:add"
            })
            .state('product.goods.edit', { // 编辑商品 编辑商品
                ...
                controllerAs: 'vm',
                title: '编辑商品',
                permission: "shopapp:store:product:goods:edit"
            })
            .state('product.server', { // 服务项目管理
                url: '/server',
                template: '<div ui-view></div>',
                title: '服务管理',
                permission: "shopapp:store:product:server:view"
            })
            ...
            .state('product.server.add', { // 新增项目
                ...
                controllerAs: 'vm',
                title: '新增服务',
                permission: "shopapp:store:product:server:edit"
            })
            ...
            .state('product.package', { // 套餐管理
                ...
                template: '<div ui-view></div>',
                title: '套餐管理',
                permission: "shopapp:store:product:package:view"
            })
            ...
            .state('product.package.add', { // 新增套餐
                ...
                controllerAs: 'vm',
                title: '新增套餐',
                permission: "shopapp:store:product:package:add"
            })
            .state('product.package.edit', { // 编辑套餐
                ...
                controllerAs: 'vm',
                title: '编辑套餐',
                permission: "shopapp:store:product:package:edit"
            })
            .state('trade', { // 交易管理
                url: '/trade',
                template: '<div ui-view></div>',
                title: '交易管理',
                permission: "shopapp:store:trade:porder:view"
            })
            ...
            .state('trade.order.add', { // 新增订单
                ...
                controllerAs: 'vm',
                title: '新增订单',
                permission: "shopapp:store:trade:porder:add",
            ...
            .state('trade.order.detail', { // 订单详情
                ...
                controllerAs: 'vm',
                title: '订单详情',
                permission: "shopapp:store:trade:porder:detail"
            })
            .state('trade.comment', { // 评价管理
                url: '/comment',
                template: '<div ui-view></div>',
                title: '评价管理',
                permission: "shopapp:store:trade:comment:view"
            })
            ...
            .state('finance', { // 财务管理
                ...
                template: '<div ui-view></div>',
                title: '财务管理',
                permission: "shopapp:store:finance:journal:view"
            })
            ...
            .state('user', { // 会员管理
                ...
                template: '<div ui-view></div>',
                title: '会员管理',
                permission: "shopapp:store:user:customer:view"
            })
            ...
            .state('user.customer.add', { // 新增会员
                ...
                controllerAs: 'vm',
                title: '新增会员',
                permission: "shopapp:store:user:customer:add"
            })
            ...
            .state('user.customer.edit', { // 编辑会员
                ...
                controllerAs: 'vm',
                title: '编辑会员',
                permission: "shopapp:store:user:customer:edit"
            })
            ...
            .state('user.grades', { // 会员等级
                ...
                template: '<div ui-view></div>',
                title: '会员等级',
                permission: "shopapp:store:user:customer:grades:view"
            })
            ...
            .state('user.am', { // 智能提醒
                ...
                template: '<div ui-view></div>',
                title: '精准提醒',
                permission: "shopapp:store:user:am:view"
            })
            ...
            .state('user.debitcard', { // 储存卡账单
                ...
                template: '<div ui-view></div>',
                title: '储存卡账单',
                permission: "shopapp:store:user:debitcard:view"
            })
            ...
            .state('stocks', { // 货源中心
                ...
                template: '<div ui-view></div>',
                title: '货源中心',
                permission: "shopapp:store:stocks:terminal:view"
            })
            ...
            .state('member', { // 员工管理
                ...
                template: '<div ui-view></div>',
                title: '员工管理',
                permission: "shopapp:store:member:employee:view"
            })
            ...
            .state('member.employee.add', { // 添加新员工管理
                ...
                controllerAs: 'vm',
                title: '添加新员工',
                permission: "shopapp:store:member:employee:add"
            })
            .state('member.employee.edit', { // 编辑员工员工管理
                ...
                controllerAs: 'vm',
                title: '编辑员工',
                permission: "shopapp:store:member:employee:edit"
            })
            .state('member.role', { // 权限管理
                url: '/role',
                template: '<div ui-view></div>',
                title: '权限管理',
                permission: "shopapp:store:member:role:view"
            })
            ...
            .state('system', { // 系统管理
                ...
                template: '<div ui-view></div>',
                title: '系统管理',
                permission: "shopapp:store:system:modpwd:view"
            })
            ...
            .state('system.personal', { // 个人信息
                ...
                template: '<div ui-view></div>',
                title: '个人信息',
                permission: "shopapp:store:system:personal:view"
            })
            ...
            .state('markting', { // 营销中心
                ...
                template: '<div ui-view></div>',
                title: '营销中心',
                permission: "shopapp:store:markting:debitcard:view"
            })
            ...
            .state('markting.package', { // 套餐卡活动
                ...
                template: '<div ui-view></div>',
                title: '套餐卡活动',
                permission: "shopapp:store:markting:package:view"
            })
            ...
            .state('markting.jk', { // 积客劵活动
                ...
                template: '<div ui-view></div>',
                title: '积客劵',
                permission: "shopapp:store:markting:jk:view"
            })
            ...
            .state('markting.jksendrecorde', { // 发放记录
                ...
                template: '<div ui-view></div>',
                title: '积客劵发放记录',
                permission: "shopapp:store:markting:jk:sendrecorde:view"
            })
