...
(function() {
    ...
    /** @ngInject */
    function tadeOrderShare($q, $state, $filter, simpleDialogService, computeService, tadeOrder, utils, webSiteApi, configuration) {
        /**
         * 关闭订单
         * @param item
         * @returns {promise}
            ...
            DEFAULT_GRID: {
                ...
                "config": {
                    ...
                    'addColumnsBarDirective': [
                        '<a class="u-btn u-btn-primary u-btn-sm" cb-access-control="shopapp:store:trade:porder:add" ui-sref="trade.order.add()">开　单</a> '
                    ],
