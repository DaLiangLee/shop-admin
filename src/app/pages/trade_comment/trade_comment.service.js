            ...
            DEFAULT_GRID: {
                "columns": [
                    ...
                    },
                    {
                      ...
                      "name": "评分",
                      "cssProperty": "state-column",
                      "fieldDirective": '<ul><li>技术评分：<div cb-score-star="item.star.skill">{{item.star.skill}}</div></li><li>服务评分：<div cb-score-star="item.star.service">{{item.star.service}}</div></li><li>环境评分：<div cb-score-star="item.star.environment">{{item.star.environment}}</div></li></ul>'
                    },
                    {
                      "id": 3,
                      "name": "评价时间",
                    ...
                    },
                    {
                      ...
                      "name": "评价图片",
                      "cssProperty": "state-column",
                      "fieldDirective": '<span class="state-unread" ng-repeat="pic in item.pic"><img bo-src-i="{{pic}}"></span>'
                    },
                    {
                      "id": 7,
                      "name": "评价内容",
