...
(function() {
  ...
  angular
    .module('shopApp')
    .directive('replyCommentDialog', replyCommentDialog);

  /** @ngInject */
  function replyCommentDialog(cbDialog) {
    return {
      restrict: "A",
      scope: {
        item: "=",
      ...
      link: function(scope, iElement){
        ...
        iElement.click(function (t) {
          ...
          t.preventDefault();
          t.stopPropagation();
          cbDialog.showDialogByUrl("app/pages/trade_comment/reply_comment_dialog.html", handler, {
            windowClass: "viewFramework-reply-comment-dialog"
          });
        })
      }
    }
